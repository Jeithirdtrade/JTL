...
<head>
    <meta charset="UTF-8">
    <title>Mwaka Mpya wa Kiislamu · Fataki ndogo · Fomu moja kwa moja</title>
...
<body>
    ...
    <div class="box">
        <div class="arabic">
            ──────⊹⊱✫⊰⊹──────<br>
            سَنَةٌ هِجْرِيَّةٌ جَدِيدَةٌ مُبَارَكَةٌ<br>
            ──────⊹⊱✫⊰⊹──────
        </div>
        <h2><i class="fas fa-star"></i> MWAKA MPYA WA HIJRIA <i class="fas fa-star"></i></h2>
        <p>
            <b>HAJI JECHA KHAMIS akishirikiana na JTL Zanzibar</b><br>
            amekutumia ujumbe maalum wa kukutakia kheri za Mwaka Mpya wa Kiislamu.
        </p>
    ...
    <div id="overlay" class="surprise-overlay">
        <div class="surprise-card">
            <h2>
                🎁 ──────⊹⊱✫⊰⊹──────<br>
                كُلُّ عَامٍ وَأَنْتُمْ بِخَيْرٍ<br>
                ──────⊹⊱✫⊰⊹──────
            </h2>
            <p>🤍 Heri ya Mwaka Mpya wa Hijria 🤍</p>
